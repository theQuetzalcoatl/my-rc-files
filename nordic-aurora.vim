...
hi IncSearch        guisp=NONE guifg=#101416 guibg=#3A4352 ctermfg=231 ctermbg=234 gui=bold cterm=bold
...
hi Search           guisp=NONE guifg=#101416 guibg=#3A4352 ctermfg=231 ctermbg=234 gui=bold cterm=bold
